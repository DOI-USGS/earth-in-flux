export default {
    ...
    visualizations: {
        GlacierScan: {
            ...
            paragraph1: "The Juneau Icefield is located just north of Juneau Alaska and extends to the Canadian border. In 2016 and 2017, researchers collected ice cores across the Juneau Icefield to investigate whether ice cores can record wildfires. Use the interactive visualization below to explore the the rock and ice topography.",
