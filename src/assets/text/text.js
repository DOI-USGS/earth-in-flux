export default {
    ...
    visualizations: {
        ...
        RegionalFires: {
            heading: "Regional Fire Deposition",
            ...
            paragraph2: "Researchers use an atomospheric model to trace the potential path of smoke particles generated by known wildfires, identifying 'candidate' fires that could have been the source for aerosols deposited on the ice field during the sampled period."
        },
        ThreatBumpChart: {
