export default {
    ...
    visualizations: {
        GlacierScan: {
            ...
            paragraph1: "The Juneau Icefield is located just north of Juneau Alaska and extends to the Canadian border. In 2016 and 2017, researchers collected ice cores across the Juneau Icefield to investigate whether ice cores can record wildfires.",
            promptDesktop: "Hover over the map to explore the topography and learn about coring a glacier.",
            promptMobile: "Click on the map to explore the topography and learn about coring a glacier",
            heading2: "How are the ice cores collected?",
            ...
            photo018Mobile: "While a new core section is being drilled, team members determine the physical properties such as ice stratigraphy and mass of the previous core section.",
            ...
            photo138Mobile: "Traversing between camps involves skiing across glaciers and hiking over slopes. Teams practice safety skills like crevasse rescue and rope management.",
            ...
            photo156Mobile: "After multiple days without snowfall, a ski track develops from people passing through on their way to collect scientific data and explore the landscape.",
            ...
            photo183Mobile: "Crevasses form in glaciers where it stretches through extension or when passing over obstacles. Traveling through crevasse fields requires caution.",
